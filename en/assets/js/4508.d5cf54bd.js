...
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(88626);
...
var addEntity = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(name, alias = void 0) {
  if (!entities.has(name)) {
    entities.set(name, { attributes: [], alias });
    _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .log */ .Rm.info("Added new entity :", name);
  } else if (!entities.get(name).alias && alias) {
    entities.get(name).alias = alias;
    _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .log */ .Rm.info(`Add alias '${alias}' to entity '${name}'`);
  }
  return entities.get(name);
}, "addEntity");
var getEntities = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(() => entities, "getEntities");
var addAttributes = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(entityName, attribs) {
  let entity = addEntity(entityName);
  let i;
  for (i = attribs.length - 1; i >= 0; i--) {
    entity.attributes.push(attribs[i]);
    _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .log */ .Rm.debug("Added attribute ", attribs[i].attributeName);
  }
}, "addAttributes");
var addRelationship = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(entA, rolA, entB, rSpec) {
  let rel = {
    entityA: entA,
    roleA: rolA,
    entityB: entB,
  ...
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .log */ .Rm.debug("Added new relationship :", rel);
}, "addRelationship");
var getRelationships = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(() => relationships, "getRelationships");
...
var erDb_default = {
  Cardinality,
  Identification,
  getConfig: /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(() => (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)().er, "getConfig"),
  addEntity,
  addAttributes,
  getEntities,
  addRelationship,
...
var insertMarkers = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(elem, conf2) {
  let marker;
...
var drawAttributes = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)((groupNode, entityTextNode, attributes) => {
...
var drawEntities = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(svgNode, entities2, graph) {
...
var adjustEntities = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(svgNode, graph) {
...
var getEdgeName = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(rel) {
  return (rel.entityA + rel.roleA + rel.entityB).replace(/\s/g, "");
}, "getEdgeName");
var addRelationships = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(relationships2, g) {
...
var relCnt = 0;
var drawRelationshipFromLayout = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(svg, rel, g, insert, diagObj) {
  relCnt++;
  const edge = g.edge(
...
var draw = /* @__PURE__ */ (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(text, id, _version, diagObj) {
  conf = (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)().er;
  _chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .log */ .Rm.info("Drawing ER diagram");
  ...
  let g;
  g = new dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_2__/* .Graph */ .T({
    multigraph: true,
    directed: true,
    compound: false
  }).setGraph({
  ...
  _chunk_TLUHKHBO_mjs__WEBPACK_IMPORTED_MODULE_0__/* .utils_default */ ._K.insertTitle(svg, "entityTitleText", conf.titleTopMargin, diagObj.db.getDiagramTitle());
  const svgBounds = svg.node().getBBox();
  const width = svgBounds.width + padding * 2;
  const height = svgBounds.height + padding * 2;
  (0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .configureSvgSize */ .a$)(svg, height, width, conf.useMaxWidth);
  svg.attr("viewBox", `${svgBounds.x - padding} ${svgBounds.y - padding} ${width} ${height}`);
}, "draw");
var MERMAID_ERDIAGRAM_UUID = "28e9f9db-3c8d-5aa5-9faf-44286ae5937c";
function generateId(str = "", prefix = "") {
  const simplifiedStr = str.replace(BAD_ID_CHARS_REGEXP, "");
  return `${strWithHyphen(prefix)}${strWithHyphen(simplifiedStr)}${(0,uuid__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A)(
    str,
    MERMAID_ERDIAGRAM_UUID
  )}`;
}
(0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(generateId, "generateId");
function strWithHyphen(str = "") {
  return str.length > 0 ? `${str}-` : "";
}
(0,_chunk_S24QXQKS_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(strWithHyphen, "strWithHyphen");
