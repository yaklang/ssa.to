            ...
            <div className={classNames(styles["virtual-table-heard"])}>
              <div className={classNames(styles["virtual-table-heard-left"])}>
                {title && typeof title === "string" && (
                  <div
                    className={classNames(styles["virtual-table-heard-title"])}
                  >
                    {title}
                  </div>
                )}
                ...
                {props.isShowTotal && pagination?.total >= 0 && (
                  <div className={styles["virtual-table-heard-right"]}>
                    <div className={styles["virtual-table-heard-right-item"]}>
                      <span
                        className={styles["virtual-table-heard-right-text"]}
                      >
                        Total
                      </span>
                      <span
                        className={styles["virtual-table-heard-right-number"]}
                      >
                        {pagination?.total || 0}
                      </span>
                    </div>
              ...
              {extra && React.isValidElement(extra) && (
                <div
                  className={classNames(styles["virtual-table-heard-right"])}
                >
                  {extra}
                </div>
              )}
          ...
          >
            ...
            <div
              ...
              className={classNames(
                ...
                {
                  [styles["virtual-table-container-none-select"]]:
                    lineIndex > -1,
                },
                containerClassName
              )}
            >
              <div
                ref={columnsRef}
                className={classNames(styles["virtual-table-col"])}
              >
        ...
        <div className={styles["virtual-table-title-icon"]}>
          ...
          {columnsItem.sorterProps?.sorter && (
            <>
              {disableSorting ? (
                <div
                  className={classNames(styles["virtual-table-sorter-disable"])}
                >
                  <DisableSorterIcon />
                </div>
              ) : (
              ...
              >
                <div
                  className={classNames(styles["virtual-table-filter"], {
                    [styles["virtual-table-filter-value"]]: columnsItem
                      .filterProps.filterMultiple
                      ? filters[filterKey] && filters[filterKey].length > 0
                      : filters[filterKey] &&
                        filters[filterKey] !==
                          (columnsItem.filterProps.filtersSelectAll?.textAll ||
                            "all"),
                  })}
                  onClick={() => {
                    setOpensPopover({
  ...
  (props: CellRenderProps) => {
    ...
    const rowBgColorFlagFun = (color: string) => {
      return (
        ...
        item.data["cellClassName"].indexOf(`color-opacity-bg-${color}`) !== -1
      );
    };
    return (
      <div
        className={classNames(
          ...
          item.data["cellClassName"],
          {
            ...
            [styles["virtual-table-active-row-red"]]:
              isSelect && rowBgColorFlagFun("red"),
            [styles["virtual-table-active-row-green"]]:
              isSelect && rowBgColorFlagFun("green"),
            [styles["virtual-table-active-row-blue"]]:
              isSelect && rowBgColorFlagFun("blue"),
            [styles["virtual-table-active-row-yellow"]]:
              isSelect && rowBgColorFlagFun("yellow"),
            [styles["virtual-table-active-row-orange"]]:
              isSelect && rowBgColorFlagFun("orange"),
            [styles["virtual-table-active-row-purple"]]:
              isSelect && rowBgColorFlagFun("purple"),
            [styles["virtual-table-active-row-lakeBlue"]]:
              isSelect && rowBgColorFlagFun("lakeBlue"),
            [styles["virtual-table-active-row-cyan"]]:
              isSelect && rowBgColorFlagFun("cyan"),
            [styles["virtual-table-active-row-bluePurple"]]:
              isSelect && rowBgColorFlagFun("bluePurple"),
            [styles["virtual-table-active-row-grey"]]:
              isSelect && rowBgColorFlagFun("grey"),
            ...
            {(list.length > 0 &&
              list.map((item) => (
                <div
                  key={item.data.value}
                  className={classNames(styles["select-item"], {
                    [styles["select-item-active-single"]]:
        ...
        {filterSearch && (
          <div className={styles["select-heard"]} ref={selectRef}>
            <Select
              ...
              style={{ width: 124 }}
              onChange={(v, o) =>
                onChangeSelect(v as string[], o as FiltersItemProps[])
              }
              allowClear
...
export const FooterBottom: React.FC<FooterBottomProps> = React.memo((props) => {
  ...
  return (
    <div className={classNames(styles["select-footer"], className)}>
      <div
        className={classNames(styles["footer-bottom"], styles["select-reset"])}
        onClick={() => onReset()}
      >
        重置
      </div>
      <div
        className={classNames(styles["footer-bottom"], styles["select-sure"])}
        onClick={() => onSure()}
      >
        确定
      </div>
